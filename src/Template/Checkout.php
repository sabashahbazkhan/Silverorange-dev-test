                ...
                <form method="post" accept-charset="utf-8" action="checkout" class="form" novalidate="novalidate">
                        ...
                        <div class="frame__contents">
                            <table class="order-summary">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a target="_blank" href="/images/product.jpg">
                                                <img class="product-img-thumb" src="/images/product.jpg" alt="Product thumbnail">
                                            </a>
                                        </td>
                                        <td>Lorem Widget</td>
                                        <td>1</td>
                    ...
                    <div class="frame">
                        <div class="frame__contents">
                            ...
                            <div class="form-field">
                                <input type="submit" class="default-btn full" value="Place Order" title="Place Order">
                            </div>
                        </div>
                    </div>
                </form>
